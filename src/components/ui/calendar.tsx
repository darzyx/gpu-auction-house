    ...
    return (
        <DayPicker
            ...
            classNames={{
                ...
                head_row: "flex",
                head_cell: "text-muted-foreground rounded-md w-10 md:w-14 font-normal text-[0.8rem]",
                ...
                day: cn(
                    ...
                    "w-10 h-10 md:w-14 md:h-14 font-normal aria-selected:opacity-100 flex flex-col justify-center items-center"
                ),
                    ...
                    return (
                        <>
                            ...
                            {renderPrice && (
                                <span
                                    className={cn(
                                        "text-[0.7rem] md:text-xs leading-none -mt-1.5 font-berkeley-mono",
                                        makePriceVisible
                                            ? isRangeExtremity
                                                ? "text-green-400"
                                                : "text-green-600"
