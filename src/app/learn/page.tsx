                    ...
                    <ScrollArea className="h-[calc(100vh-220px)]">
                        ...
                        >
                            ...
                            <section className="space-y-4">
                                ...
                                <ul className="space-y-2 ml-6 list-disc">
                                    ...
                                    <li>
                                        Pick a specific date range and a
                                        start/end hour
                                    </li>
                                    <li>
                            ...
                            <section className="space-y-4">
                                ...
                                <ul className="space-y-2 ml-6 list-disc">
                                    ...
                                    <li>
                                        Ability to resell unused compute time
                                        and recover costs
                                    </li>
                                    <li>
                        ...
                        <TabsContent value="market" className="space-y-4 mr-6">
                            <section className="space-y-4">
                                ...
                                <p>
                                    GPU Exchange operates as a two-sided market
                                    with buy orders and sell orders. Unlike
                                    traditional GPU cloud providers with fixed
                                    pricing, our market allows prices to be
                            ...
                            <section className="space-y-4">
                                ...
                                <p>
                                    The market combines multiple buyers and
                                    sellers to facilitate efficient
                                ...
                                <ul className="space-y-2 ml-6 list-disc">
                                    ...
                                    <li>
                                        Buyer A is willing to pay $10/GPU/hour
                                        for part of it
                                    </li>
                                    <li>
                                ...
                                <p>
                                    This mechanism helps match supply with
                                    demand while finding the optimal price for
                                    all parties.
                                </p>
                                <Separator />
                            </section>
                            <section className="space-y-4">
                                ...
                                <p>
                                    ...
                                    orders for any future time slot. Each
                                    compute block starts at the hour you specify
                                    and runs for your chosen duration.
                                </p>
                            </section>
                        </TabsContent>
                        <TabsContent value="orders" className="space-y-4 mr-6">
                            <section className="space-y-4">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <p>
                                        ...
                                        need immediate access to GPUs and price
                                        is less important.
                                    </p>
                                </div>
                                <div className="space-y-2">
                                    ...
                                    <p>
                                        ...
                                        These orders wait until someone is
                                        willing to trade at your price.
                                    </p>
                                </div>
                                <Separator />
                            </section>
                            <section className="space-y-4">
                                ...
                                <ul className="space-y-2 ml-6 list-disc">
                                    <li>
                                        Number of GPUs (any quantity available)
                                    </li>
                                    <li>Duration (hours or days)</li>
                                    <li>Start date and time</li>
                                    <li>
                                        Price per GPU per hour (for limit
                                        orders)
                                    </li>
                                </ul>
                                <Separator />
                            ...
                            <section className="space-y-4">
                                ...
                                <p>
                                    While market orders provide immediate
                                    execution, you can often get better prices
                                    using limit orders. This strategy works well
                                    for:
                                </p>
                                <ul className="space-y-2 ml-6 list-disc">
                                    <li>
                                        Catching discounted rates during
                                        off-peak hours
                                    </li>
                                    <li>
                                        Taking advantage when others need to
                                        sell quickly
                                    </li>
                                    <li>
                                        Planning ahead for future compute needs
                                    </li>
                                </ul>
                            </section>
                        </TabsContent>
                        <TabsContent value="pricing" className="space-y-4 mr-6">
                            <section className="space-y-4">
                                ...
                                <p>
                                    GPU Exchange uses market-based pricing,
                                    which means prices fluctuate based on supply
                                    and demand. Each block of compute time is
                            ...
                            <section className="space-y-4">
                                ...
                                <p>
                                    Use this data to gain an understanding of
                                    recent market trends and make informed
                                    trading decisions.
                                </p>
                            </section>
                        </TabsContent>
